...
Application.prototype = {
    ...
    setOptions: function(options) {
        ...
        this.notify("optionsChanged", options);
         ...
         LOG.warn("checking options changed.");
	        LOG.warn("Project Name = "+ options.projectName);
	        var locator = options.projectName
		window['workingproject'] = locator;
		//loadProject(options.projectName);
		window['currentProject'] = locator;
